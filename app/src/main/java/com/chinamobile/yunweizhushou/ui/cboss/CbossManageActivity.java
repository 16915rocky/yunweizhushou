...
public class CbossManageActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cboss_manage);
		initView();
		initViewPager();
		initEvent();
		initRequest();
...
@Override
	...
	private void initViewPager() {
		...
		CbossFragment cbossFragment1 = new CbossFragment();
		Bundle bundle1 = new Bundle();
		bundle1.putInt("tag",CbossFragment.WARNING);
		cbossFragment1.setArguments(bundle1);
		fragmentList.add(cbossFragment1);

		CbossFragment cbossFragment2 = new CbossFragment();
		Bundle bundle2 = new Bundle();
		bundle2.putInt("tag",CbossFragment.MONITOR);
		cbossFragment2.setArguments(bundle2);
		fragmentList.add(cbossFragment2);
	...
	private void initEvent() {
		getTitleBar().setMiddleText("Cboss专区");
	...
	private void initView() {
		item1 = (TextView) findViewById(R.id.cboss_item1);
		item2 = (TextView) findViewById(R.id.cboss_item2);
		viewPager = (ViewPager) findViewById(R.id.cboss_viewpager);
		bottomBar = findViewById(R.id.cboss_bottom_bar);
	...
	public void onClick(View v) {
		resetAll();
		switch (v.getId()) {
		case R.id.cboss_item1:
			viewPager.setCurrentItem(0);
			item1.setTextColor(getResources().getColor(R.color.color_lightblue));
			break;
		case R.id.cboss_item2:
