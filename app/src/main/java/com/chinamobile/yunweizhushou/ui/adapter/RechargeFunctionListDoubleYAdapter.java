...
public class RechargeFunctionListDoubleYAdapter extends BaseAdapter {
	...
	public RechargeFunctionListDoubleYAdapter(Context c, List<RechargeFunctionGraphBean.ItemsList> data) {
		this.mContext = c;
		this.data = data;
	}
