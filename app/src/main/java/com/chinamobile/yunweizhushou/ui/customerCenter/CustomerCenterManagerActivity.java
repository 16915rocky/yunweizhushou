package com.chinamobile.yunweizhushou.ui.customerCenter;
...
public class CustomerCenterManagerActivity extends BaseActivity {
    ...
    private void initEvent() {
        getTitleBar().setMiddleText("客户中心");
