...
public class ServiceChainManageActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViewPager() {
        ...
        BusinessHealthFragment businessHealthFragment = new BusinessHealthFragment();
        fragmentList.add(businessHealthFragment);

        ServiceChainTab2Fragment serviceChainTab2Fragment = new ServiceChainTab2Fragment();
        fragmentList.add(serviceChainTab2Fragment);
    ...
    private void initEvent() {
        getTitleBar().setMiddleText("业务启示录");
