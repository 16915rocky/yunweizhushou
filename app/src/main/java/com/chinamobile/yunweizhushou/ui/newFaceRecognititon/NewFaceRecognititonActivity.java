...
import static com.chinamobile.yunweizhushou.R.id.item6_3;

/**
 * Created by Administrator on 2017/8/14.
 */

public class NewFaceRecognititonActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_face_recognititon);
    ...
    private void initEvent() {
        ...
        item83.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.item6_3:
                intent.setClass(this,FILEIDDetailActivity.class);
                break;
            case R.id.item8_3:
                intent.setClass(this,CRMAPPDetailActivity.class);
                break;
            default:break;
        }
