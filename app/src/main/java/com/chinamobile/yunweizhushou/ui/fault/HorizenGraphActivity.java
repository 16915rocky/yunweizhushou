...
public class HorizenGraphActivity extends BaseActivity implements OnClickListener {
	...
	protected void onTaskFinish(HttpRequestEnum e, ResponseBean responseBean) {
		...
		case enum_govern_analysis_graph_detail:
			...
			if (responseBean.isSuccess()) {
				// data = Utils.getJsonArray(responseBean.getDATA());
				try {
					//JSONArray jsonArray = new JSONArray(data);
					JSONObject jsonObject = new JSONObject(responseBean.getDATA());
					//JSONObject jsonObject = jo.getJSONObject(position);
