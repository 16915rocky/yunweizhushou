...
import com.chinamobile.yunweizhushou.ui.bandService.fragments.BandServiceGraphListwithShadowFragment;
import com.chinamobile.yunweizhushou.ui.bandService.fragments.BandServiceTab1Fragment;
import com.chinamobile.yunweizhushou.utils.ConstantValueUtil;

import java.util.ArrayList;
import java.util.List;

public class BandServiceActivity2 extends BaseActivity implements View.OnClickListener {
    ...
    private void initViewPager() {
        ...
        BandServiceTab1Fragment bandServiceTab1Fragment = new BandServiceTab1Fragment();
        fragmentList.add(bandServiceTab1Fragment);
        BandServiceGraphListwithShadowFragment graphListwithShadowFragment = new BandServiceGraphListwithShadowFragment();
        Bundle bundle = new Bundle();
        bundle.putString("action","findRelatedRate");
        fragmentList.add(graphListwithShadowFragment);
