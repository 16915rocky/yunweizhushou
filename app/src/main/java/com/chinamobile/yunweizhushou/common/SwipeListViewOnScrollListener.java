...
public class SwipeListViewOnScrollListener implements OnScrollListener {
	...
	public SwipeListViewOnScrollListener(SwipeRefreshLayout swipeView, OnScrollListener onScrollListener) {
		mSwipeView = swipeView;
