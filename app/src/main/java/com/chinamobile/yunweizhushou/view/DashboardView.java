...
public class DashboardView extends View {
    ...
    private int mBigSliceCount; //<!-- 长刻度条数-->
    private int mSliceCountInOneBigSlice; //<!-- 短刻度条数-->
    ...
    private int mStripeWidth; // <!--色带宽度-->
    private StripeMode mStripeMode = StripeMode.NORMAL;
    private int mBigSliceRadius; // 长刻度半径
    private int mSmallSliceRadius; // 短刻度半径
    private int mNumMeaRadius; // 鏁板瓧鍒诲害鍗婂緞
    private int mModeType;
    private List<HighlightCR> mStripeHighlight; // 楂樹寒鑼冨洿棰滆壊瀵硅薄鐨勯泦鍚�
    private int mBgColor; // 鑳屾櫙鑹�

    private int mViewWidth; // 鎺т欢瀹藉害
    private int mViewHeight; // 鎺т欢楂樺害
    ...
    private int mSmallSliceCount; // 鐭埢搴︿釜鏁�
    private float mBigSliceAngle; // 澶у埢搴︾瓑鍒嗚搴�
    private float mSmallSliceAngle; // 灏忓埢搴︾瓑鍒嗚搴�

    private String[] mGraduations; // 绛夊垎鐨勫埢搴﹀��
    private float initAngle;
    private boolean textColorFlag = true; // 鑻ヤ笉鍗曠嫭璁剧疆鏂囧瓧棰滆壊锛屽垯鏂囧瓧鍜屽渾寮у悓鑹�
    private boolean mAnimEnable; // 鏄惁鎾斁鍔ㄧ敾
    private MyHandler mHandler;
    private long duration = 500; // 鍔ㄧ敾榛樿鏃堕暱
    ...
    /**
     * float绫诲瀷濡傛灉灏忔暟鐐瑰悗涓洪浂鍒欐樉绀烘暣鏁板惁鍒欎繚鐣�
     */
